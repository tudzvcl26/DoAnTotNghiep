...
import { adminJobsKey, getAdminJobs } from './admin.api'
...
export function AdminJobsPage() {
  ...
  return <main className="admin-page">
    <header className="admin-page__hero"><div><span>Recruitment operations</span><h1>Quản lý việc làm</h1><p>Danh sách toàn hệ thống dùng ADMIN bypass của owner-scoped Recruitment Service API.</p></div><BriefcaseBusiness /></header>
