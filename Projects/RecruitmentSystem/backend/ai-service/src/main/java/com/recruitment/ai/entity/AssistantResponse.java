...
@Table(name = "assistant_responses")
@EntityListeners(AuditingEntityListener.class)
public class AssistantResponse {
    @Id @GeneratedValue(strategy = GenerationType.UUID) private UUID id;
    @OneToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "session_id", nullable = false, unique = true) private AssistantSession session;
    ...
    @Column(name = "response_data", nullable = false, columnDefinition = "JSONB") private String responseData;
