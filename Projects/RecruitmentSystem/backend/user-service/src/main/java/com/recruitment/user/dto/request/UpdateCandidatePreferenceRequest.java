...
@Getter @Setter public class UpdateCandidatePreferenceRequest {
    @DecimalMin("0.0") private BigDecimal salaryMinimum;
    @DecimalMin("0.0") private BigDecimal salaryMaximum;
    @Size(min = 3, max = 3) private String salaryCurrency;
